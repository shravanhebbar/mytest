...
public class HotelsMappingApplication {
	public static final int NUM_ATTRS = 7;

	public static final String PATH_TO_TRAINDATA_FILE = "Data/data.data";
	public static final String PATH_TO_TESTDATA_FILE = "Data/CL_TestData.data";
			...
			for (Instance Testdata : instances_Testdata) {
				...
				for (Instance train : instances_Traindata) {
					if ( !Testdata.getOta().equalsIgnoreCase(train.getOta())) {
						...
						if( Testdata.getPostalcode().equalsIgnoreCase(train.getPostalcode())||train.getPostalcode()=="0" ) {
							//if(Testdata.getCity().equalsIgnoreCase(train.getCity()))
							//{
							try {

								distance  =FuzzySearch.ratio(Testdata.getName().toLowerCase(),train.getName().toLowerCase());
								if(distance>=70){
...

				{
					...
					for(int i=0;i<K;i++) {
							...
							file.write(distances.get(i).getInstance()+"===="+distances.get(i).getNametrain()+"====="+Km+"KM");//+"===="+s.getCity());
							file.write("\n");
						}*/
					...
					if(K>=2) {
						...
						for(int i=0;i<K;i++) {
							...
							if(distances.get(i).getOta().equals("TRAVELGURU")&& OtacountTR!=1) {

								if(distances.get(i).getOta().equals("TRAVELGURU")){

									OtacountTR=OtacountTR+1;
								...
								{ 
									//int i=0;	
									if(distances.get(i).getLat1Distance() ==0 || distances.get(i).getLog1Distance()==0 || distances.get(i).getLat2Distance() ==0|| distances.get(i).getLog2Distance()==0 ) {
							...
							else if(distances.get(i).getOta().equals("CLEARTRIP") && OtacountCL!=1){
								if(distances.get(i).getOta().equals("CLEARTRIP")){

									OtacountCL=OtacountCL+1;
							...
							}else if(distances.get(i).getOta().equals("GOOMO")&& OtacountGM!=1) {

								if(distances.get(i).getOta().equals("GOOMO")){

									OtacountGM=OtacountGM+1;;
					...
					}else
					{
						...
						{ if(distances.get(i).getLat1Distance() ==0|| distances.get(i).getLog1Distance()==0) {
							if(distances.get(i).getDistance()>=80) {
